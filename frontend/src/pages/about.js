...
const AboutMe = () => {
  return (
    <div className="bg-black text-white min-h-screen flex items-center justify-center pb-32">
      <div className="max-w-4xl px-4 py-8">
      <h1 className="text-4xl sm:text-8xl md:text-8xl font-extralight mb-8 font-archivo ml-0 sm:ml-0 md:ml-0 lg:-ml-32" id='about'>About me</h1>
        <p className="text-base sm:text-xl md:text-xl leading-relaxed font-ibm-plex-sans" id='aboutText'>
